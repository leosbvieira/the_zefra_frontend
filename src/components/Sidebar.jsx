...
const Sidebar = ({ isExpanded, setIsExpanded }) => {
  const sections = [
    { label: "Item 1", icon: <LayoutDashboard size={20} /> },
  ...
  return (
    <div
      className={`fixed top-0 left-0 h-screen z-40 bg-white border-r shadow-md transition-all duration-300 flex flex-col ${
