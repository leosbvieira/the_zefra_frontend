...
const TopNavbar = () => {
  ...
  const menuItems = [
    { label: "BI de Fundos" },
    { label: "Análise Ativos" },
    {
      label: "Arquivos Envio",
  ...
  <div className="bg-white rounded-full px-4 py-2 shadow-sm border border-gray-200 flex items-center space-x-4">
    ...
    <div className="flex items-center space-x-1">
      {menuItems.map((item, idx) => (
        ...
        >
          <button className="flex items-center px-4 py-2 rounded-full hover:bg-gray-100 text-sm font-medium text-gray-800 whitespace-nowrap">
            {item.label}
